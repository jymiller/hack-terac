...
export const CERTS = [
  {
    id: "rennick",
    file: "rennick-harbours-compliance-certificate-2026-06-30",
    pages: 3,
    entity: "Rennick Harbours Limited",
    truth: {
      entity: "Rennick Harbours Limited",
      period_end: "2026-06-30",
      ratio_name: "Interest Cover Ratio",
      ratio_value: "2.92",
      numerator: "412.6",
      denominator: "141.4",
      trigger_level: "1.85",
    ...
    check: { num: 412.6, den: 141.4, printed: 2.92 },
    accept: { entity: ["Rennick Harbours Ltd"], ratio_name: ["Interest Cover"] },
    distractors: {
      ratio_value: { value: "3.04", why: "Interest Cover Ratio at the preceding Calculation Date, printed two rows below" },
      ratio_name: { value: "Leverage Ratio", alt: ["Net Borrowings to EBITDA Ratio"], why: "Schedule 2 certifies a second ratio, 5.53" },
      period_end: { value: "2026-07-21", why: "Date of the Certificate, not the Calculation Date" },
    },
  },
  {
    id: "cawdrey",
    file: "cawdrey-crossing-compliance-certificate-2026-03-31",
    pages: 3,
    entity: "Cawdrey Crossing Operations Limited",
    truth: {
      entity: "Cawdrey Crossing Operations Limited",
      period_end: "2026-03-31",
      ratio_name: "Historic Debt Service Cover Ratio",
      ratio_value: "1.44",
      numerator: "194.7",
      denominator: "134.9",
      trigger_level: "1.20",
    ...
    check: { num: 194.7, den: 134.9, printed: 1.44 },
    accept: { entity: ["Cawdrey Crossing Operations Ltd"], ratio_name: ["Historic DSCR", "DSCR"] },
    distractors: {
      ratio_value: { value: "1.37", why: "Historic DSCR at the previous Calculation Date" },
      numerator: { value: "214.6", why: "Net cash flow from operating activities — the first of four blocks that sum to 194.7" },
      denominator: { value: "96.5", why: "Interest paid on Senior Debt — the first of two blocks summing to 134.9" },
    },
  },
  {
    id: "ravensmoor",
    file: "ravensmoor-water-compliance-certificate-2026-03-31",
    pages: 3,
    entity: "Ravensmoor Water Limited",
    truth: {
      entity: "Ravensmoor Water Limited",
      period_end: "2026-03-31",
    ...
    check: { num: 331.3, den: 132.9, printed: 2.49 },
    accept: { entity: ["Ravensmoor Water Ltd"], ratio_name: ["Senior ICR"] },
    distractors: {
      ratio_value: { value: "2.61", why: "Senior ICR at the previous Calculation Date" },
      numerator: { value: "412.6", why: "Cashflow from Operations, before three adjustments that net to 331.3" },
